...
public class TodoService {
    ...
    public TodoService(DataSource dataSource) throws TodoServiceException {
        ...
        try (Connection conn = db.open()) {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS game (id INTEGER PRIMARY KEY, " +
                         "                                  player_id TEXT, pieceType TEXT)" ;//game_id TEXT,
    ...
    /*
    public Game createNewGame(String pieceType, String body) throws TodoServiceException {
        ...
        String sql = "INSERT INTO game ( player_id, pieceType) " +
        ...
        try (Connection conn = db.open()) {
            ...
            logger.error("TodoService.createNewGame: Failed to create new entry", ex);
            throw new TodoServiceException("TodoService.createNewGame: Failed to create new entry", ex);
        }
